...
fail_compilation/lint_unused_params.d(38): Warning: [unusedParams] function parameter `b` is never used
fail_compilation/lint_unused_params.d(47): Warning: [unusedParams] function parameter `y` is never used
fail_compilation/lint_unused_params.d(51): Error: template instance `lint_unused_params.tplFunc!int` error instantiating
fail_compilation/lint_unused_params.d(56): Warning: [unusedParams] function parameter `b` is never used
fail_compilation/lint_unused_params.d(68): Warning: [unusedParams] function parameter `z` is never used
